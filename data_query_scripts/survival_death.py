...
if __name__ == '__main__':
    ...
    features, outcomes, data2, hospital, record_id = prepare_for_learning(data, data_struct,
                                                              variables_to_include,
    ...
    times = data['days_until_outcome_3wk'].copy()  # TIME THAT PEOPLE DIED
    ...
    plt.savefig('Cox_coef_all.png', format='png', dpi=300, figsize=(3,23), pad_inches=0, bbox_inches='tight')

    # %%
    cphplt = cox_plot_pvalue_only(cph, 0.05)
    plt.savefig('Cox_coef_pvalue_.05.png', format='png', dpi=300, figsize=(7,9), pad_inches=0, bbox_inches='tight')
    # run on command line:
